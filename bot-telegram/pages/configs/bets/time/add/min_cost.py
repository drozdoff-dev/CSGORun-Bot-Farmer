...
def call_page(app_path,command):
    ...
    info_user_tg.storage['args']['time_bet']['cost_max'] = 0.0
    ...
    if(create_cost_min >= 0.1):
        info_user_tg.storage['active_page']['configs']['bets']['time']['add']['min_cost']['max_cost'] = {}
        info_user_tg.storage['args']['time_bet']['cost_min'] = create_cost_min
