...
def call_page(app_path,command):
    ...
    info_user_tg.storage['args']['time_bet']['coef_min'] = 0.0
    ...
    if(create_cost_max >= 0.1):
        if(create_cost_max >= info_user_tg.storage['args']['time_bet']['cost_min']):
            info_user_tg.storage['active_page']['configs']['bets']['time']['add']['min_cost']['max_cost']['min_coef'] = {}
            info_user_tg.storage['args']['time_bet']['cost_max'] = create_cost_max
