...
def call_page(app_path,command):
    ...
    info_user_tg.storage['args']['time_bet']['coef_max'] = 0.0
    ...
    if(create_coef_min >= 1.01):
        info_user_tg.storage['active_page']['configs']['bets']['time']['add']['min_cost']['max_cost']['min_coef']['max_coef'] = {}
        info_user_tg.storage['args']['time_bet']['coef_min'] = create_coef_min
